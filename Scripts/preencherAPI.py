...
def preencherAPI(calculoFluxoPath, textoContrato, textoLaudo, textoParticipantes):
    ...
    calculoFluxoWeb = driver.find_element('xpath','//*[@id="main"]/div/section[1]/div/div/form/fieldset[1]/div[1]/label/input')
    ...
    codigoIntegracao2.send_keys(contrato['CCI'])
    ...
    cartorio = driver.find_element('xpath','//*[@id="numero_cartorio"]').click()              # Por enquanto tem que arrumar na Az até Tech arrumar
    sleep(1)
    selectCartorio = driver.find_element('xpath','//*[@id="numero_cartorio"]/div[2]/ul/li[1]').click()
    ...
    for quantidade in range(0, contador):
        ...
        relacao.click()
        if Participantes[f'relacaoDoP{quantidade+1}'] == 'Titular': driver.find_element('xpath','/html/body/div[1]/main/div/section[1]/div/div/form/fieldset[3]/div/label[2]/select/option[2]')
        elif Participantes[f'relacaoDoP{quantidade+1}'] == 'Cônjuge': driver.find_element('xpath','/html/body/div[1]/main/div/section[1]/div/div/form/fieldset[3]/div/label[2]/select/option[3]')
        elif Participantes[f'relacaoDoP{quantidade+1}'] == 'Procurador': driver.find_element('xpath','/html/body/div[1]/main/div/section[1]/div/div/form/fieldset[3]/div/label[2]/select/option[4]')
        elif Participantes[f'relacaoDoP{quantidade+1}'] == 'Pai': driver.find_element('xpath','/html/body/div[1]/main/div/section[1]/div/div/form/fieldset[3]/div/label[2]/select/option[5]')
        elif Participantes[f'relacaoDoP{quantidade+1}'] == 'Mãe': driver.find_element('xpath','/html/body/div[1]/main/div/section[1]/div/div/form/fieldset[3]/div/label[2]/select/option[6]')
        elif Participantes[f'relacaoDoP{quantidade+1}'] == 'Irmão': driver.find_element('xpath','/html/body/div[1]/main/div/section[1]/div/div/form/fieldset[3]/div/label[2]/select/option[7]')
    ...
    if contrato['indice'] == 'IPCA':
        indice.click()
        indice =driver.find_element('xpath','/html/body/div/main/div/section[1]/div/div/form/fieldset[6]/div/label[3]/select').click()

    if contrato['tabela'] == 'PRICE' or contrato['tabela'] == 'Price' or contrato['tabela'] == 'price':
        tipoAmortização.click()
        tipoAmortização =driver.find_element('css','#tipo_amortizacao > option:nth-child(2)').click()

    elif contrato['tabela'] == 'SAC':
        tipoAmortização.click()
        tipoAmortização =driver.find_element('xpath','#tipo_amortizacao > option:nth-child(1)').click()
